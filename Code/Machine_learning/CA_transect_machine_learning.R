...
plot_deseq2_DiffAbunMicob <- function(physeq_obj, ASV_number, FACTOR1 = "rootstock", FACTOR2 = FALSE){
  ...
  if (isFALSE(FACTOR2) && (FACTOR1) == "rootstock"){
    ...
    x <- ggplot(TEMP2, aes(plant_body_site, ASV_count, fill= lower_political)) + geom_boxplot(outlier.shape = NA) + geom_point(position = position_jitterdodge(jitter.width = 0.2)) + scale_fill_manual(name = "Site", values=site_palette) + scale_y_continuous(name="VS Transformed Abundance") + xlab("Compartment") + theme(legend.position="right", axis.title = element_text(size = 14), axis.text = element_text(size = 12), plot.title = element_text(size=22)) + ggtitle(paste("ASV", aes_string(ASV_number)))
  ...
  if ((FACTOR1) == "rootstock" && (FACTOR2) == "site" || (FACTOR1) == "site" && (FACTOR2) == "rootstock"){
    x <- ggplot(TEMP2, aes(rootstock, ASV_count, fill= lower_political)) + geom_boxplot(outlier.shape = NA) + geom_point(position = position_jitterdodge(jitter.width = 0.2)) + scale_fill_manual(name = "Site", values=site_palette) + scale_y_continuous(name="VS Transformed Abundance") + xlab("Rootstock") + theme(legend.position="right", axis.title = element_text(size = 14), axis.text = element_text(size = 12), plot.title = element_text(size=22)) + ggtitle(paste("ASV", aes_string(ASV_number)))
    ...
    x <- ggplot(TEMP2, aes(scion, ASV_count, fill= lower_political)) + geom_boxplot(outlier.shape = NA) + geom_point(position = position_jitterdodge(jitter.width = 0.2)) + scale_fill_manual(name = "Site", values=site_palette) + scale_y_continuous(name="VS Transformed Abundance") + xlab("Scion") + theme(legend.position="right", axis.title = element_text(size = 14), axis.text = element_text(size = 12), plot.title = element_text(size=22)) + ggtitle(paste("ASV", aes_string(ASV_number)))
    ...
    x <- ggplot(TEMP2, aes(year, ASV_count, fill= lower_political)) + geom_boxplot(outlier.shape = NA) + geom_point(position = position_jitterdodge(jitter.width = 0.2)) + scale_fill_manual(name = "Site", values=site_palette) + scale_y_continuous(name="VS Transformed Abundance") + xlab("Year") + theme(legend.position="right", axis.title = element_text(size = 14), axis.text = element_text(size = 12), plot.title = element_text(size=22)) + ggtitle(paste("ASV", aes_string(ASV_number)))
    ...
    x <- ggplot(TEMP2, aes(brix_2_breaks, ASV_count, fill= lower_political)) + geom_boxplot(outlier.shape = NA) + geom_point(position = position_jitterdodge(jitter.width = 0.2)) + scale_fill_manual(name = "Site", values=site_palette) + scale_y_continuous(name="VS Transformed Abundance") + xlab("Sugar content") + theme(legend.position="right", axis.title = element_text(size = 14), axis.text = element_text(size = 12), plot.title = element_text(size=22)) + ggtitle(paste("ASV", aes_string(ASV_number)))
  }
  return(x)
}
